...
loadstring(game:HttpGet("https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Tag"))()
end))
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Reanimate.lua"))()
...
local exploit = "shitsploit"
	...
	local customasset = function(id)
        ...
        if not isfile(id) then 
         writefile(id,game:HttpGet("https://github.com/ilikeices/animated/tree/Audios-1"..idwithoutthatbit))
        end
...
local function DanceAsset(file)
    ...
    if not isfile(filePath) then 
        ...
        local success, errorMsg = pcall(function()
            writefile(filePath, game:HttpGet("https://github.com/ilikeices/animated/blob/Audios-1/"..file.."?raw=true"))
        end)
...
INPUTLOOP = uis.InputBegan:Connect(function(k,chatting)
	...
	if mode == 1 then 
		if k == "q" then 
			if dancing == false then 
				...
				local dance=LoadDance("Rat1", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Rat1.lua")
				Info("Rat 1","Q")
				sound69:Play()
				if dance then
		...
		elseif k == "r" then 
			if dancing == false then 
				...
				sound69.PlaybackSpeed = 1
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Assumptions", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Assumptions.lua")
				sound69:Play()
				Info("Assumptions","R")
				if dance then
		...
		elseif k == "t" then 
			if dancing == false then 
				...
				sound69.PlaybackSpeed = 1
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Egypt", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Egypt.lua")
				sound69:Play()
				Info("Egypt","T")
				if dance then
		...
		elseif k == "y" then 
			if dancing == false then 
				...
				sound69.PlaybackSpeed = 1
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Flop", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Flop.lua")
				sound69:Play()
				Info("Flop","Y")
				if dance then 
		...
		elseif k == "f" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("HeelToeHop", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/HeelToeHop.lua")
				sound69:Play()
				Info("Heel Toe Hop","F")
				if dance then
				playanim(dance)
		...
		elseif k == "p" then 
			if dancing == false then 
				...
				if isfile and not isfile("KDV3/Monkey.mp3") then 
				  writefile("KDV3/Takino.mp3",game:HttpGet("https://github.com/ilikeices/animated/blob/Audios-1/Monkey.mp3?raw=true"))
				  end 
				sound69.SoundId = getcustomasset("KDV3/Monkey.mp3")
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("BombMonkey", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Bomb Monkey.lua")
				Info("Bomb Monkey","P")
				sound69:Play()
				if dance then
				playanim(dance)
		...
		elseif k == "h" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Domino", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Domino.lua")
				sound69:Play()
				Info("Domino","H")
				if dance then 
		...
		elseif k == "v" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Liar", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Liar.lua")
				sound69:Play()
				Info("Liar","V")
				if dance then
		...
		elseif k == "c" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Mesmerizer", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Mesmerizer.lua")
				sound69:Play()
				Info("Mesmerizer","C")
				if dance then
		...
		elseif k == "n" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("BoxSwing", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Box Swing.lua")
				sound69:Play()
				Info("Box Swing","N")
				if dance then
				playanim("BoxSwing")
		...
		elseif k == "comma" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Static", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Static.lua")
				sound69:Play()
				Info("Static",",")
				if dance then 
		...
		elseif k == "leftbracket" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Prism", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Prism Shuffle.lua")
				sound69:Play()
				Info("Prism","[")
				if dance then
				playanim(dance)
		...
		elseif k == "rightbracket" then 
			if dancing == false then 
				...
				local dance=LoadDance("Headlock", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Headlock.lua")
				sound69:Play()
				Info("Headlock","]")
				if dance then
				playanim(dance)
		...
		elseif k == "b" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Hakari", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Hakari.lua")
				sound69:Play()
				Info("Hakari","B")
				if dance then 
				     playanim(dance)
		...
		elseif k == "minus" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Commercial", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Commercial.lua")
				sound69:Play()
				Info("Commercial","-")
				if dance then
				playanim("Commercial")
	...
	if mode == 2 then 
		...
		elseif k == "e" then
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Soda", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Soda Pop.lua")
				sound69:Play()
				Info("Soda","E")
				if dance then
		...
		elseif k == "r" then
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("L4U", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Love4U.lua")
				sound69:Play()
				Info("L4U","R")
				if dance then
		...
		elseif k == "h" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Distraction", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Distraction.lua")
				sound69:Play()
				Info("Distraction","H")
				if dance then 
				playanim(dance)
		...
		elseif k == "g" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("ItBurns", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/It Burns.lua")
				sound69:Play()
				Info("ItBurns","G")
				if dance then
		...
		elseif k == [[f]] then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Chronoshift", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Chronoshift.lua")
				sound69:Play()
				Info("Chronoshift","F")
				if dance then 
		...
		elseif k == "j" then 
			if dancing == false then 
				...
				sound69.PlaybackSpeed = 1
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Keep", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Keep Up.lua")
				sound69:Play()
				Info("Keep Up","J")
		...
		elseif k == "n" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Sit", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Sit.lua")
				sound69:Play()
		...
		elseif k == "v" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("BillieJean", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/BillieJean.lua")
				sound69:Play()
				Info("BJ","V")
				if dance then
				playanim(dance) -- uuid. 118311613925473
		...
		elseif k == "b" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Savor", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Savor.lua")
				sound69:Play()
				Info("Savor","B")
				if dance then 
				playanim(dance) -- uuid. 118311613925473
		...
		elseif k == "p" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Yamero", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Yamero.lua")
				sound69:Play()
				Info("Yamero","P")
				if dance then
				playanim(dance) -- uuid. 118311613925473
		...
		elseif k == "comma" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Angel", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Angel.lua")
				sound69:Play()
				Info("Angel",",")
				if dance then
				playanim(dance) -- uuid. 118311613925473
		...
		elseif k == "minus" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("ClubPenguin", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Club Penguin.lua")
				sound69:Play()
				Info("Club","-")
				if dance then
				playanim(dance) -- uuid. 118311613925473
		...
		elseif k == "leftbracket" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Runaway", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Runaway.lua")
				sound69:Play()
				Info("Runaway","[")
				if dance then
				playanim(dance) -- uuid. 118311613925473
		...
		elseif k == "rightbracket" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Miohonda", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Miohonda.lua")
				sound69:Play()
				Info("MioHonda","]")
				if dance then
				playanim(dance) -- uuid. 118311613925473
		...
		elseif k == "l" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Firework", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Firework.lua")
				sound69:Play()
				Info("Firework","L")
				if dance then
				playanim(dance) -- uuid. 118311613925473
	...
	if mode == 3 then 
		if k == "q" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition  
				local dance=LoadDance("C14", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/C14.lua")
				sound69:Play()
				Info("C14","Q")
				if dance then 
		...
		elseif k == "e" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Slickback", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Slickback.lua")
				sound69:Play()
				Info("Slickback","E")
				if dance then
		...
		elseif k == "r" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Doodle", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Doodle.lua")
				sound69:Play()
				Info("Doodle","R")
				if dance then
		...
		elseif k == "t" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Goat", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Goat.lua")
				sound69:Play()
				Info("Goat","T")
				if dance then
		...
		elseif k == "y" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Bumblebee", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Bumblebee.lua")
				sound69:Play()
				Info("Bumblebee","Y")
				if dance then
		...
		elseif k == "u" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Stock", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Stock Shuffle.lua")
				sound69:Play()
				Info("Stock","U")
				if dance then
		...
		elseif k == "p" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Rat2", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Rat2.lua")
				sound69:Play()
				Info("Rat 2","P")
				if dance then
				playanim(dance) -- uuid. 8915458946
		...
		elseif k == "f" then 
			if dancing == false then 
				...
				"https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Shuba Duck.lua")
				sound69:Play()
				Info("Shuba Duck","F")
				     if dance then
		...
		elseif k == "h" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Birdbrain", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Birdbrain.lua")
				Info("Birdbrain","H")
				sound69:Play()
				if dance then
		...
		elseif k == "j" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Fein", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Fein.lua")
				sound69:Play()
				Info("Fein","J")
				if dance then
				playanim(dance) -- uuid. 13357063395
		...
		elseif k == "k" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Popipo", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Popipo.lua")
				sound69:Play()
				Info("Popipo","K")
				if dance then
				playanim(dance) -- uuid. 13357063395
		...
		elseif k == "l" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Pickup", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Pickup.lua")
				sound69:Play()
				Info("Pickup","L")
				if dance then
				playanim(dance) -- uuid. 13357063395
		...
		elseif k == "z" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Billy", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Billy.lua")
				sound69:Play()
				Info("Yourself","Z")
				if dance then
		...
		elseif k == "c" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Spooky", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Spooky.lua")
				sound69:Play()
				Info("Spooky","C")
				if dance then
		...
		elseif k == "v" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Limited", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Limited.lua")
				sound69:Play()
				Info("JK","V")
				if dance then
		...
		elseif k == "b" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Flexworks", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Flexworks.lua")
				sound69:Play()
				Info("KJ","B")
				if dance then
		...
		elseif k == "n" then 
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				--Dance_48=LoadDance("CrissCross", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/CrissCross.lua")
				Info("CrissCross","N")
	...
	if mode == 4 then
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Unlockit", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Unlockit.lua")
				sound69:Play()
				Info("Unlockit","Q")
				if dance then
				playanim(dance) -- uuid. 71723925114737
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("SmoothMoves", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/SmoothMoves.lua")
				sound69:Play()
				Info("Smooth Moves","E")
				if dance then
				playanim(dance) -- 
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Lagtrain", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Lagtrain.lua")
				sound69:Play()
				Info("Lagtrain","R")
				if dance then
				playanim(dance) -- uuid. 71723925114737
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Suki", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Suki.lua")
				sound69:Play()
				Info("Suki","T")
				if dance then
				playanim(dance) -- uuid. 71723925114737
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Cafeteria", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Cafeteria.lua")
				sound69:Play()
				Info("Cafeteria","Y")
				if dance then
				playanim(dance) -- uuid. 71723925114737
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Dare", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Dare.lua")
				sound69:Play()
				Info("Dare","U")
				if dance then
				playanim(dance) -- uuid. 71723925114737
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Tenna", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Tenna.lua")
				sound69:Play()
				Info("Tenna 1","P")
				if dance then
				playanim(dance) 
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Insanity", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Insanity.lua")
				sound69:Play()
				Info("Insanity","F")
				if dance then
				playanim(dance) 
			...
			if dancing == false then 
				...
				sound69.SoundId = DanceAsset("Tenna.mp3")
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Tenna2", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Tenna 2.lua")
				sound69:Play()
				Info("Tenna 2","G")
				if dance then
				playanim(dance) -- uuid. 71723925114737
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Rambunctious", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Rambunctious.lua")
				sound69:Play()
				Info("Rambunctious","H")
				if dance then
				playanim(dance) 
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Sideshuffle", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Side Shuffle.lua")
				sound69:Play()
				Info("Side Shuffle","J")
				if dance then
				playanim(dance) -- uuid. 71723925114737
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Electro", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Electro Swing.lua")
				sound69:Play()
				Info("Electo","K")
				if dance then
				playanim(dance) -- uuid. 71723925114737
			...
			if dancing == false then 
				...
				sound69.SoundId = DanceAsset("MioHonda.mp3")
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Step", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Step.lua")
				sound69:Play()
				Info("Step","L")
				char.Humanoid.WalkSpeed = 4*char:GetScale()
				if dance then
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Applepen", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Apple Pen.lua")
				sound69:Play()
				Info("Apple Pen","Z")
				if dance then 
				playanim(dance) -- uuid. 71723925114737
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Crankthat", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Crank That.lua")
				sound69:Play()
				Info("Crank That","X")
				if dance then
				playanim(dance) -- uuid. 71723925114737
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Takedown", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Takedown.lua")
				Info("TakeDown","C")
				sound69:Play()
				if dance then
				playanim(dance) 
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Down", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Going Down.lua")
				sound69:Play()
				Info("Going Down","V")
				if dance then
				playanim(dance) 
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Spamton", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Spamton.lua")
				sound69:Play()
				Info("Spamton","B")
				if dance then
				playanim(dance) 
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Kemusan", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Kemusan.lua")
				sound69:Play()
				Info("Kemusan","N")
				if dance then
				playanim(dance) 
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("ImOk", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/ImOk.lua")
				sound69:Play()
				Info("Im Ok",",")
				if dance then
				playanim(dance) 
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Igaku", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Igaku.lua")
				sound69:Play()
				Info("Igaku","-")
				if dance then
				playanim(dance) 
			...
			if dancing == false then 
				...
				sound69.SoundId = DanceAsset("Headlock.mp3")
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Headlock3", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Headlock3.lua")
				Info("Headlock 2","[")
				sound69:Play()
				if dance then
				playanim(dance) 
			...
			if dancing == false then 
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Guli", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Guli.lua")
				sound69:Play()
				Info("Guli Guli","]")
				if dance then
				playanim(dance) 
	...
	if mode == 5 then
	     if k == "q" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Results", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Results.lua")
				sound69:Play()
				Info("Results","Q")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "e" then
			if dancing == false then
				...
				sound69.SoundId = DanceAsset("Static.mp3")
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Static2", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Static2.lua")
				sound69:Play()
				Info("Static 2","E")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "r" then
			if dancing == false then
				...
				sound69.SoundId = DanceAsset("Billy.mp3")
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Billy2", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Billy2.lua")
				sound69:Play()
				Info("Billy 2","R")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "t" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Yell", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Yell.lua")
				sound69:Play()
				Info("Yell 2","T")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "y" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Yell1", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Yell1.lua")
				sound69:Play()
				Info("Yell 3","Y")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "u" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Yell2", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Yell2.lua")
				sound69:Play()
				Info("Yell 1","U")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "p" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Touch", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Touch.lua")
				sound69:Play()
				Info("Touch","P")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "j" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				local dance=LoadDance("CyberBop", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/CyberBop.lua")
				sound69:Play()
				Info("CyberBop","J")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "k" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				local dance=LoadDance("Invincible", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Invincible.lua")
				sound69:Play()
				Info("Invincible","K")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "l" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				local dance=LoadDance("Jumpstyle3", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Jumsptyle3.lua")
				sound69:Play()
				Info("Jumpstyle","L")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "z" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				local dance=LoadDance("BreakDance", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/BreakDance.lua")
				sound69:Play()
				Info("BreakDance","Z")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "x" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				local dance=LoadDance("BreakDance2005", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/BreakDance2005.lua")
				sound69:Play()
	     ...
	     elseif k == "c" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				local dance=LoadDance("Requiem", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Requiem.lua")
				sound69:Play()
				Info("Requiem","C")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "v" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				local dance=LoadDance("Metro", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Metro.lua")
				sound69:Play()
				Info("Metro Man","V")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "b" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				local dance=LoadDance("CrackDown", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/CrackDown.lua")
				sound69:Play()
				Info("Crack Down","B")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "n" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				local dance=LoadDance("Smug", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Smug.lua")
				sound69:Play()
				Info("Smug Dance","N")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "rightbracket" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				local dance=LoadDance("Wait", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Wait.lua")
				sound69:Play()
				Info("Wait","]")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "leftbracket" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				local dance=LoadDance("Jumpstyle4", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Jumpstyle4.lua")
				sound69:Play()
				Info("Jumpstyle 1","[")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "minus" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				sound69:Play()
				local dance=LoadDance("KeepUp1", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Keep Up1.lua")
				sound69:Play()
				Info("Keep Up 1","-")
				if dance then
				playanim(dance) 
	     ...
	     elseif k == "comma" then
			if dancing == false then
				...
				sound69:Play()
				char.Humanoid.WalkSpeed = 4*char:GetScale()
				local dance=LoadDance("Livesey", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Livesey.lua")
				sound69:Play()
				Info("Livesey",",")
				if dance then
				playanim(dance) 
	...
	if mode == 6 then 
	  if k == "q" then
			if dancing == false then
				...
				sound69.SoundId = DanceAsset("Mesmerizer.mp3")
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Mesmerizer1", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Mesmerizer.lua")
				sound69:Play()
				Info("Mesmerizer 1","Q")
				if dance then
				playanim(dance) 
	  ...
	  elseif k == "e" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Pokedance", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Pokedance.lua")
				sound69:Play()
				Info("Pokedance","E")
				if dance then
				playanim(dance) 
	  ...
	  elseif k == "r" then
			if dancing == false then
				...
				if isfile and not isfile("KDV3/Takino.mp3") then 
				  writefile("KDV3/Takino.mp3",game:HttpGet("https://github.com/ilikeices/animated/blob/Audios-1/Takino.mp3?raw=true"))
				  end 
				sound69.SoundId = getcustomasset("KDV3/Takino.mp3")
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("Takino", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Takino.lua")
				sound69:Play()
				Info("Takino","R")
				if dance then
				playanim(dance) 
	  ...
	  elseif k == "t" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("SpokenFor", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Spoken For.lua")
				sound69:Play()
				Info("Spoken For","T")
				if dance then
				playanim(dance) 
	  ...
	  elseif k == "y" then
			if dancing == false then
				...
				timeposcur = sound69.TimePosition 
				local dance=LoadDance("GetDown", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Get Down.lua")
				sound69:Play()
				Info("Get Down","Y")
				if dance then
				playanim(dance) 
	...
	if char.Humanoid.Sit == false then 
		if char.Humanoid.MoveDirection == Vector3.new(0,0,0) and dancing == false and idle == false then
			...
			if idle == true and walking == false and char.Humanoid.MoveDirection == Vector3.new(0,0,0) and dancing == false and playanother==true then
			  ...
			  if uh==1 then
				local dance=LoadDance("Pixelation", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Pixelation.lua")
				     if dance then
					playanim(dance,2.2,false)
				     end
			  elseif uh==2 then
			       local dance=LoadDance("Idle2", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Idle2.lua")
				  if dance then
					playanim(dance,2.2,false)
					end
				end
		...
		elseif char.Humanoid.MoveDirection ~= Vector3.new(0,0,0) and dancing == false and walking == false then 
			...
			if sprinting == false then 
				...
				if walking == true and idle == false and  char.Humanoid.MoveDirection ~= Vector3.new(0,0,0) and dancing == false and playanother==true  then 
				     local dance=LoadDance("Sprint", "https://raw.githubusercontent.com/ilikeices/animated/refs/heads/main/Sprint.lua")
				     if dance then
					playanim(dance,2.2,false)
					end
				end
